...
class APIDocumentationGenerator {
    constructor(fastify, outputDir = './docs/api') {
...
`;
     ...
     */
    async writeDocumentationFiles(docs) {
        // Write OpenAPI specification
        await (0, promises_1.writeFile)((0, path_1.join)(this.outputDir, 'openapi.json'), JSON.stringify(docs.openApiSpec, null, 2), 'utf8');
        // Write routes summary
        await (0, promises_1.writeFile)((0, path_1.join)(this.outputDir, 'routes-summary.json'), JSON.stringify(docs.routesSummary, null, 2), 'utf8');
        // Write authentication guide
        await (0, promises_1.writeFile)((0, path_1.join)(this.outputDir, 'authentication-guide.md'), docs.authenticationGuide, 'utf8');
        // Write error codes reference
        await (0, promises_1.writeFile)((0, path_1.join)(this.outputDir, 'error-codes.json'), JSON.stringify(docs.errorCodesReference, null, 2), 'utf8');
        // Write comprehensive API reference
        const apiReference = this.generateMarkdownReference(docs);
        await (0, promises_1.writeFile)((0, path_1.join)(this.outputDir, 'api-reference.md'), apiReference, 'utf8');
        console.log(`📚 API documentation generated in ${this.outputDir}`);
    }
    /**
     * Generate comprehensive markdown API reference
     */
    generateMarkdownReference(docs) {
...
`;
    ...
    async generatePostmanCollection() {
        ...
        await (0, promises_1.writeFile)((0, path_1.join)(this.outputDir, 'FastRevedKids-API.postman_collection.json'), JSON.stringify(collection, null, 2), 'utf8');
        return collection;
    }
}
