...
exports.getOptimizedPoolConfig = exports.productionOptimizations = exports.queryOptimizationConfig = exports.poolMonitoringConfig = exports.optimizedPoolConfig = void 0;
...
function calculateOptimalPoolSize() {
    ...
    else if (config_1.config.NODE_ENV === 'test') {
...
exports.optimizedPoolConfig = {
    ...
    ssl: config_1.config.NODE_ENV === 'production' && config_1.config.DB_SSL_CA ? {
...
exports.poolMonitoringConfig = {
    ...
    enableQueryLogging: config_1.config.NODE_ENV !== 'production',
    enableSlowQueryLogging: true,
    enableConnectionLogging: config_1.config.NODE_ENV === 'development',
};
...
exports.queryOptimizationConfig = {
    ...
    // Cache settings
    queryCacheEnabled: config_1.config.NODE_ENV === 'production',
...
exports.productionOptimizations = {
    ...
    enableConnectionEncryption: config_1.config.NODE_ENV === 'production',
    enableSlowQueryLog: true,
    slowQueryThreshold: 2000, // 2 seconds for slow query log
    enableGeneralLog: config_1.config.NODE_ENV === 'development',
...
function getOptimizedPoolConfig() {
    const baseConfig = { ...exports.optimizedPoolConfig };
    // Apply production optimizations
    if (config_1.config.NODE_ENV === 'production') {
        return {
            ...baseConfig,
            connectionLimit: exports.productionOptimizations.maxPoolSize,
        };
    }
...
exports.getOptimizedPoolConfig = getOptimizedPoolConfig;
