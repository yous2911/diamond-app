...
async function seedDatabase() {
    try {
        ...
        const students = await connection_1.db.insert(schema.students).values([
            {
                prenom: 'Lucas',
                nom: 'Martin',
        ...
        const modules = await connection_1.db.insert(schema.modules).values([
            {
        ...
        await connection_1.db.insert(schema.exercises).values(exercisesToInsert);
        console.log('✅ Exercises seeded successfully');
        // Seed some sample progress
        console.log('📈 Seeding sample progress...');
        await connection_1.db.insert(schema.studentProgress).values([
            {
                studentId: 1,
                exerciseId: 1,
                competenceCode: 'MATH_COUNT_01',
