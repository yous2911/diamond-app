...
export const mockExercises: Exercise[] = [
  ...
  },
  {
    ...
    correctAnswer: "Chat",
    options: { choices: ["Chien", "Chat", "Oiseau", "Poisson"] },
    difficultyLevel: 1,
    xpReward: 10,
    timeLimit: 30,
    hintsAvailable: 2,
  ...
  },
  {
    ...
    correctAnswer: "Petit",
    options: { choices: ["Petit", "Moyen", "Énorme", "Large"] },
    difficultyLevel: 2,
    xpReward: 15,
    timeLimit: 45,
    hintsAvailable: 3,
  ...
  },
  {
    ...
    correctAnswer: "Paris",
    options: { choices: ["Lyon", "Paris", "Marseille", "Toulouse"] },
    difficultyLevel: 3,
    xpReward: 20,
    timeLimit: 60,
    hintsAvailable: 4,
