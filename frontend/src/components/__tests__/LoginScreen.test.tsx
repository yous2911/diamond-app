...
describe('LoginScreen', () => {
  describe('Rendering', () => {
    it('should render login screen with all elements', () => {
      ...
      // Check for submit button - could be either "Se connecter" or "Connexion..." based on loading state
      expect(screen.getByRole('button', { name: /se connecter|connexion/i })).toBeInTheDocument();
  ...
  describe('Form Interaction', () => {
    ...
    it('should disable submit button when form is incomplete', () => {
      ...
      const submitButton = screen.getByRole('button', { name: /se connecter|connexion/i });
  ...
  describe('Error Handling', () => {
    it('should display login error message', async () => {
      ...
      await user.click(screen.getByRole('button', { name: /se connecter|connexion/i }));
