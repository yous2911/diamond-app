        ...
        {competenceProgress.slice(0, maxItems).map((progress, index) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3 flex-1">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-600">
                    Niveau {progress.difficulty} • {progress.attempts} tentatives
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-right">
                  <div className="text-sm font-medium text-gray-800">
                    {Math.round((progress.successes / progress.attempts) * 100)}%
                  </div>
            ...
            <div className="mt-2 flex justify-between items-center text-xs text-gray-500">
              <span>
                Temps: {formatTime(progress.timeSpent)}
              </span>
              {progress.lastPracticed && (
                <span>
                  Dernière pratique: {new Date(progress.lastPracticed).toLocaleDateString()}
                </span>
              )}
            </div>
          </motion.div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <div className="text-lg font-bold text-blue-600">
                      {selectedProgress.difficulty}
                    </div>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <div className="text-sm text-gray-600">Taux de réussite</div>
                    <div className="text-lg font-bold text-green-600">
                      {Math.round((selectedProgress.successes / selectedProgress.attempts) * 100)}%
                    </div>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <div className="text-sm text-gray-600">Tentatives</div>
                    <div className="text-lg font-bold text-purple-600">
                      {selectedProgress.attempts}
                    </div>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <div>
                  ...
                  <div className="flex justify-between text-xs text-gray-500 mt-1">
                    <span>{selectedProgress.successes} réussies</span>
                    <span>{selectedProgress.attempts} tentatives</span>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 p-3 rounded-lg">
                  ...
                  {selectedProgress.nextReview && (
                    <div className="text-xs text-blue-600 mt-1">
                      Prochaine révision: {new Date(selectedProgress.nextReview).toLocaleDateString()}
                    </div>
                  )}
                </div>
              </div>
