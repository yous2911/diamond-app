...
interface Particle {
  ...
  type: 'fire' | 'water' | 'magic' | 'crystal' | 'lightning' | 'smoke' | 'sparkle' | 'heart' | 'star' | 'glitch';
  physics: {
    gravity: number;
    friction: number;
    elasticity: number;
...
interface AdvancedParticleEngineProps {
  ...
  particleType: 'fire' | 'water' | 'magic' | 'crystal' | 'lightning' | 'smoke' | 'sparkle' | 'heart' | 'star' | 'glitch';
  behavior?: 'normal' | 'spiral' | 'orbit' | 'explosion' | 'attract' | 'repel';
...
const AdvancedParticleEngineOlderStudents: React.FC<AdvancedParticleEngineProps> = ({
  width = 800,
  height = 600,
  particleCount = 100,
  particleType,
...
export default AdvancedParticleEngineOlderStudents;
