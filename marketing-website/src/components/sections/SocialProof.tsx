    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          <AnimatedCard delay={0} className="bg-slate-50 rounded-2xl p-6 text-center border border-slate-100">
          ...
          <AnimatedCard delay={0.1} className="bg-slate-50 rounded-2xl p-6 text-center border border-slate-100">
          ...
          <AnimatedCard delay={0.2} className="bg-slate-50 rounded-2xl p-6 text-center border border-slate-100 flex flex-col items-center">
          ...
          <AnimatedCard delay={0.3} className="bg-slate-50 rounded-2xl p-6 text-center border border-slate-100">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <AnimatedCard delay={0} className="bg-slate-50 rounded-2xl p-8 border border-slate-100 flex flex-col justify-between">
            <div>
          ...
          <AnimatedCard delay={0.1} className="bg-slate-50 rounded-2xl p-8 border border-slate-100 flex flex-col justify-between">
            <div>
              <p className="text-slate-700 text-sm leading-relaxed mb-4">
        ...
        <AnimatedSection delay={0.2}>
          <motion.div
            whileHover={{ scale: 1.02 }}
            transition={{ duration: 0.3 }}
            className="bg-blue-600 rounded-2xl p-8 md:p-10 text-white flex flex-col md:flex-row items-start md:items-center justify-between gap-6"
          >
